...
df_249812 = pd.read_csv('data/raw/GSE249812_GSE249812_genes.fpkm.anno.txt.gz', sep='\t')
...
df_249812.to_csv('data/processed/GSE249812.csv')

# 2. GSE103182
print("Processing GSE103182")
df_103182 = pd.read_csv('data/raw/GSE103182_GSE103182_FPKM_Matrix.txt.gz', sep='\t')
...
df_103182.to_csv('data/processed/GSE103182.csv')
...
df_267256 = pd.read_csv('data/raw/GSE267256_GSE267256_MusMusculus_Counts.txt.gz', sep='\t')
...
df_267256.to_csv('data/processed/GSE267256.csv')

# 5. GSE285626 (Mouse)
print("Processing GSE285626")
df_285626 = pd.read_csv('data/raw/GSE285626_GSE285626_FPKM_allsamples.txt.gz', sep='\t')
...
df_285626.to_csv('data/processed/GSE285626.csv')

# 6. GSE304427 (Mouse)
print("Processing GSE304427")
df_304427 = pd.read_csv('data/raw/GSE304427_GSE304427_fpkm.csv.gz')
...
df_304427.to_csv('data/processed/GSE304427.csv')

print("All real data parsing complete.")
# 7. GSE154294 (Human)
print("Processing GSE154294")
df_154294 = pd.read_csv('data/raw/GSE154294.tab.gz', sep='\t')
...
df_154294.to_csv('data/processed/GSE154294.csv')
