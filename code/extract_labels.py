...
for gse_id in studies:
    ...
    try:
        ...
        for gsm_name, gsm in gse.gsms.items():
            ...
            # Simple heuristic for MI vs Control
            is_mi = False
            is_control = False

            all_text = " ".join(chars).lower() + " " + title + " " + source
            if 'mi' in all_text or 'myocardial infarction' in all_text or 'infarct' in all_text or 'disease' in all_text:
                is_mi = True
            if 'control' in all_text or 'sham' in all_text or 'healthy' in all_text or 'normal' in all_text:
                is_control = True
